...
export class LanguageLessonsController {
  constructor(private readonly languageLessonsService: LanguageLessonsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateLanguageLessonDto: UpdateLanguageLessonDto) {
